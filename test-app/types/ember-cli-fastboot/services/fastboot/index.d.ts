/*
 * Copy from: https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/ember-cli-fastboot
 * needed as prebuilt package depends on other Ember DT packages which are incompatible with the built-in types
 */
